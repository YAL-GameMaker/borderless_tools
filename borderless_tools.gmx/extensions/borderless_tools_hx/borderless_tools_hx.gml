...
// Generated at 2022-01-13 12:48:16 (434ms) for v1.4.1804+
/// @lint nullToAny true
//{ prototypes
...
// window_frame_button_create(frame:window_frame, sprite:sprite, subimg:int, onClick:function<button:window_frame_button; void>)
...
var _b = argument[0];
return sprite_get_width(_b[1/* sprite */]);
...
var _b = argument[0];
var _frame = _b[0/* frame */];
draw_sprite_ext(_b[1/* sprite */], _b[2/* subimg */], (argument[1] + ((argument[3] - sprite_get_width(_b[1/* sprite */])) div 2)), argument[2] + ((argument[4] - sprite_get_height(_b[1/* sprite */])) div 2), 1, 1, 0, _frame[1/* blend */], _frame[2/* alpha */] * ((_b[7/* enabled */] ? 1 : 0.3)));
...
// window_frame_buttons_get_x(this:window_frame_buttons, width:int)->int
var _this = argument[0], _width = argument[1];
return ((window_frame_std_haxe_boot_wget(_this[0/* frame */], 22) ? _width : _width - window_frame_std_haxe_boot_wget(_this[0/* frame */], 18))) - window_frame_buttons_get_width(_this);
...
var _this = argument[0];
_this[@4/* minimize */] = window_frame_buttons_add(_this, window_frame_button_create(_this[0/* frame */], window_frame_std_haxe_boot_wget(_this[0/* frame */], 9), 0, f_window_frame_buttons_add_default_buttons_lf));
_this[@5/* maxrest */] = window_frame_buttons_add(_this, window_frame_button_create(_this[0/* frame */], window_frame_std_haxe_boot_wget(_this[0/* frame */], 9), 1, f_window_frame_buttons_add_default_buttons_lf1));
window_frame_std_haxe_boot_wset(_this[5/* maxrest */], 11, f_window_frame_buttons_add_default_buttons_update);
_this[@6/* close */] = window_frame_buttons_add(_this, window_frame_button_create(_this[0/* frame */], window_frame_std_haxe_boot_wget(_this[0/* frame */], 9), 3, f_window_frame_buttons_add_default_buttons_lf2));
